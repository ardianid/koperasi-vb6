VERSION 5.00
Begin VB.Form frm_sel_tot_wjb 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Seleksi Total Simpanan Wajib & Sukarela"
   ClientHeight    =   3780
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5250
   ...
   End
End
Attribute VB_Name = "frm_sel_tot_wjb"
...
'    khusus_user = Mid(Utama.StatusBar1.Panels(5).Text, 7, Len(Utama.StatusBar1.Panels(5).Text))
    ...
    Load frm_lap_tot_wjb
        frm_lap_tot_wjb.Show
