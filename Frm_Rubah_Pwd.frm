...
Begin VB.Form Frm_Rubah_Pwd 
   ...
   Begin TDBContainer3D6Ctl.TDBContainer3D TDB_Karyawan 
      ...
      Enabled         =   -1  'True
      Redraw          =   -1  'True
      MouseIcon       =   "Frm_Rubah_Pwd.frx":08CA
      MousePointer    =   0
      CtrlEffectType  =   8
      CtrlEffectValue =   "Raised"
      ChildsEffectType=   8
      ChildsEffectValue=   "Inset"
      Effects         =   "Frm_Rubah_Pwd.frx":08E6
      Childs          =   "Frm_Rubah_Pwd.frx":0992
      ...
      Begin TrueOleDBGrid60.TDBGrid Grid_Karyawan 
         Height          =   2295
         Left            =   240
         OleObjectBlob   =   "Frm_Rubah_Pwd.frx":09AE
         TabIndex        =   23
         Top             =   1200
         Width           =   5655
      End
   ...
   Begin VB.Image Image1 
      Height          =   2775
      Left            =   120
      Picture         =   "Frm_Rubah_Pwd.frx":3DE0
      Stretch         =   -1  'True
      Top             =   0
      Width           =   2415
   End
