...
Begin VB.Form User_Baru 
   ...
   Begin TDBContainer3D6Ctl.TDBContainer3D TDB_Daftar 
      ...
      Enabled         =   -1  'True
      Redraw          =   -1  'True
      MouseIcon       =   "User_Baru.frx":08CA
      MousePointer    =   0
      CtrlEffectType  =   8
      CtrlEffectValue =   "Raised"
      ChildsEffectType=   8
      ChildsEffectValue=   "Inset"
      Effects         =   "User_Baru.frx":08E6
      Childs          =   "User_Baru.frx":0992
      ...
      Begin TrueOleDBGrid60.TDBGrid Grid_Daftar 
         Height          =   2415
         Left            =   240
         OleObjectBlob   =   "User_Baru.frx":09AE
         TabIndex        =   37
         Top             =   960
         Width           =   6135
      End
   ...
   Begin TDBContainer3D6Ctl.TDBContainer3D TDB_Karyawan 
      ...
      Enabled         =   -1  'True
      Redraw          =   -1  'True
      MouseIcon       =   "User_Baru.frx":43F6
      MousePointer    =   0
      CtrlEffectType  =   8
      CtrlEffectValue =   "Raised"
      ChildsEffectType=   8
      ChildsEffectValue=   "Inset"
      Effects         =   "User_Baru.frx":4412
      Childs          =   "User_Baru.frx":44BE
      Begin VB.Frame Frame5 
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9
      ...
      Begin TrueOleDBGrid60.TDBGrid Grid_Karyawan 
         Height          =   2535
         Left            =   240
         OleObjectBlob   =   "User_Baru.frx":44DA
         TabIndex        =   31
         Top             =   840
         Width           =   6135
      End
