...
Begin VB.Form frm_lap_penimbangan 
   Caption         =   "Penimbangan"
   ClientHeight    =   6630
   ClientLeft      =   60
   ClientTop       =   345
   ...
   EndProperty
   Icon            =   "frm_lap_penimbangan.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6630
   ScaleWidth      =   8175
   ...
   End
End
Attribute VB_Name = "frm_lap_penimbangan"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim Report As New rpenimbangan_new
Option Explicit
...
Set Report = New rpenimbangan_new
